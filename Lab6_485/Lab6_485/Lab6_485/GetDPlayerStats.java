...
@WebServlet("/GetDPlayerStats")
public class GetDPlayerStats  extends HttpServlet
{
	...
	public static DBentry getInstance() 
	{
		...
		public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException
		{
			...
			String query = "select FirstName,LastName,"+StatType+",Position,NFLSchema.Team.Name\n" + 
					"from NFLSchema.Person,NFLSchema.Player,NFLSchema.D_Player_Stats, NFLSchema.Team\n" + 
					"where "+StatType+" >=" +statNum+"\n" + 
					"and NFLSchema.Person.ID = NFLSchema.D_Player_Stats.P_ID \n" + 
					"and NFLSchema.Player.P_Id = NFLSchema.D_Player_Stats.P_ID \n" + 
